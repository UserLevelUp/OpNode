...
namespace UserActivityHook  {
	...
	public class UserActivityHook : object {
		...
		public static extern int SetWindowsHookEx(IntPtr idHook, HookProc lpfn, 
			IntPtr hInstance, int threadId);

        //[DllImport("user32.dll", CharSet = CharSet.Unicode)]
        //public static extern int SWH(IntPtr idHook, HookProc lpfn,
        //    IntPtr hInstance, int threadId);
		...
		public void Start()
		{
			...
			if(hMouseHook == 0)
			{
                ...
                hMouseHook = SetWindowsHookEx(new IntPtr(0), MouseHookProc, Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]),
                    0);
