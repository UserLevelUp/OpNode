...
// The 'name' attribute is invalid - The value 'pWord 0.0.6.B.Properties' is invalid according to its datatype 'http://schemas.neumont.edu/CodeGeneration/PLiX:qualifierNameType' - The Pattern constraint failed.
